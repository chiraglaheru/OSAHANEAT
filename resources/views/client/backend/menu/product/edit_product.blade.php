                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="veg_nonveg" id="veg_nonveg" class="form-select">
                                            <option value="veg" {{ $product->veg_nonveg === 'veg' ? 'selected' : '' }}>🟢 Veg</option>
                                            <option value="nonveg" {{ $product->veg_nonveg === 'nonveg' ? 'selected' : '' }}>🔴 Non-Veg</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <img id="showImage" src="{{ asset($product->image) }}" alt="Product Image"
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" name="most_populer" type="checkbox"
                                            id="mostPopular" value="1" {{ $product->most_populer == 1 ? 'checked' : '' }}>
